    ...
    className="flex flex-col items-center justify-center text-center space-y-2 max-md:px-4 my-10 mb-40">
            ...
            className="flex items-center justify-between max-w-2xl w-full md:h-13 h-12">
                <input
                    ...
                    required
                />
                <button type="submit" className="md:px-12 px-8 h-full text-white bg-blue-600 hover:bg-blue-800-dull transition-all cursor-pointer rounded-md rounded-l-none">
                    Subscribe
                </button>
            </motion.form>
        </motion.div>
